...
public:	
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
		void HitShield(AWhiteBloodCell* blood_cell, float BounceStrength, FVector ShieldLocation);
		void HitShield_Implementation(AWhiteBloodCell* blood_cell, float BounceStrength, FVector ShieldLocation) {}
